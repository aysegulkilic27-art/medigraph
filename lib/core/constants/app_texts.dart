...
class AppTexts {
  ...
  static const settingsAgeBanner =
      'Yaş, boy ve kilo bilgisi, değişiklikleri ilerleyen ölçümlerinizde ki eşik değer hesabında kullanılır. Lütfen bilgilerinizi güncel tutun.';
  static const ageWarningText =
      'Yaş, boy ve kilo bilgisi, değişimleri ilerleyen ölçümlerinizde ki eşik değer hesabında kullanılır. Lütfen bilgilerinizi güncel tutun.';
