// Tansiyon kaydını stage badge ve not ile gösteren kart widget'ı.
          ...
          if (hasNote)
            Row(
              ...
              children: [
                ...
                Icon(Icons.favorite, color: cardColor, size: AppDimensions.iconSM(context)),
              ],
            )
          else
            Icon(Icons.favorite, color: cardColor, size: AppDimensions.iconSM(context)),
